...
console.log('test 1a',createMenuItem('tacos', 8, 'Lunch'))
...
console.log('task 1b', createMenuItem('steak', 30, 'dinner' ));
...
console.log('task 6', addReview(reviews, 4));
...
console.log('test 7', getLastReview(reviews));
